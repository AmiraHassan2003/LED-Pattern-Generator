...
SOURCEFILES_QUOTED_IF_SPACED=MCAL/GPIO/hal_gpio.c app.c ECU/LED/led.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1 ${OBJECTDIR}/app.p1 ${OBJECTDIR}/ECU/LED/led.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1.d ${OBJECTDIR}/app.p1.d ${OBJECTDIR}/ECU/LED/led.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1 ${OBJECTDIR}/app.p1 ${OBJECTDIR}/ECU/LED/led.p1

# Source Files
SOURCEFILES=MCAL/GPIO/hal_gpio.c app.c ECU/LED/led.c
...
${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1: MCAL/GPIO/hal_gpio.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1 MCAL/GPIO/hal_gpio.c 
